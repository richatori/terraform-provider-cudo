	...
	resource.ParallelTest(t, resource.TestCase{
		CheckDestroy: func(state *terraform.State) error {
			...
			if err == nil && ins.Payload.VM.ShortState != "epil" {
				...
				cl.VirtualMachines.TerminateVM(terminateParams)
		...
		Steps: []resource.TestStep{
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("cudo_vm.vm", "external_ip_address"),
		...
		Steps: []resource.TestStep{
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("cudo_vm.vm-minimal", "external_ip_address"),
		...
		Steps: []resource.TestStep{
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("cudo_vm.vm-oob-delete", "external_ip_address"),
