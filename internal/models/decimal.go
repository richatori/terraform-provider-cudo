...
// Decimal A representation of a decimal value, such as 2.5. Clients may convert values
...
func (m *Decimal) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Decimal) UnmarshalBinary(b []byte) error {
	var res Decimal
