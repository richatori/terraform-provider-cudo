...
type ListSSHKeysOK struct {
	Payload *models.ListSSHKeysResponse
}
...
func (o *ListSSHKeysOK) Error() string {
	return fmt.Sprintf("[GET /v1/ssh-keys][%d] listSshKeysOK  %+v", 200, o.Payload)
}
...
func (o *ListSSHKeysOK) GetPayload() *models.ListSSHKeysResponse {
	return o.Payload
}
...
func (o *ListSSHKeysOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListSSHKeysResponse)
...
func (o *ListSSHKeysDefault) Error() string {
	return fmt.Sprintf("[GET /v1/ssh-keys][%d] ListSshKeys default  %+v", o._statusCode, o.Payload)
}
...
func (o *ListSSHKeysDefault) GetPayload() *models.Status {
	return o.Payload
}
