...
// WithProjectID adds the projectID to the get security group params
func (o *GetSecurityGroupParams) WithProjectID(projectID string) *GetSecurityGroupParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the get security group params
func (o *GetSecurityGroupParams) SetProjectID(projectID string) {
