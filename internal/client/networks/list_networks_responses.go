...
type ListNetworksOK struct {
	Payload *models.ListNetworksResponse
}
...
func (o *ListNetworksOK) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/networks][%d] listNetworksOK  %+v", 200, o.Payload)
}
...
func (o *ListNetworksOK) GetPayload() *models.ListNetworksResponse {
	return o.Payload
}
...
func (o *ListNetworksOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListNetworksResponse)
...
func (o *ListNetworksDefault) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/networks][%d] ListNetworks default  %+v", o._statusCode, o.Payload)
}
...
func (o *ListNetworksDefault) GetPayload() *models.Status {
	return o.Payload
}
