...
func (o *GetProjectOK) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{id}][%d] getProjectOK  %+v", 200, o.Payload)
}
...
func (o *GetProjectDefault) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{id}][%d] GetProject default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetProjectDefault) GetPayload() *models.Status {
	return o.Payload
}
