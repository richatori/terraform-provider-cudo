...
func (o *UpdateProjectParams) WithProject(project UpdateProjectBody) *UpdateProjectParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the update project params
func (o *UpdateProjectParams) SetProject(project UpdateProjectBody) {
	o.Project = project
}
...
func (o *UpdateProjectParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if err := r.SetPathParam("project.id", o.ProjectID); err != nil {
		return err
	}
