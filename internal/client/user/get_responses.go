...
func (o *GetOK) Error() string {
	return fmt.Sprintf("[GET /v1/auth][%d] getOK  %+v", 200, o.Payload)
}
...
func (o *GetDefault) Error() string {
	return fmt.Sprintf("[GET /v1/auth][%d] Get default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetDefault) GetPayload() *models.Status {
	return o.Payload
}
