...
// WithName adds the name to the delete Api key params
func (o *DeleteAPIKeyParams) WithName(name string) *DeleteAPIKeyParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete Api key params
func (o *DeleteAPIKeyParams) SetName(name string) {
	o.Name = name
}
