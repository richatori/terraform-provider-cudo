...
type GetInstanceOK struct {
	Payload *models.GetInstanceResponse
}
...
func (o *GetInstanceOK) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/instances/{instanceId}][%d] getInstanceOK  %+v", 200, o.Payload)
}
...
func (o *GetInstanceOK) GetPayload() *models.GetInstanceResponse {
	return o.Payload
}
...
func (o *GetInstanceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GetInstanceResponse)
...
func (o *GetInstanceDefault) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/instances/{instanceId}][%d] GetInstance default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetInstanceDefault) GetPayload() *models.Status {
	return o.Payload
}
