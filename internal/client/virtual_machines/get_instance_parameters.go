...
// WithProjectID adds the projectID to the get instance params
func (o *GetInstanceParams) WithProjectID(projectID string) *GetInstanceParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the get instance params
func (o *GetInstanceParams) SetProjectID(projectID string) {
